...
function CustomTooltip({ active, payload, label }: TooltipProps<number, string>) {
  ...
  return (
    <div style={tooltipStyle} className="px-4 py-3 shadow-xl">
      ...
      <p className="text-sm font-semibold" style={{ color: chartTheme.colors[1] }}>
        ...
        <AreaChart data={monthlyTrendData} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
          <defs>
            <linearGradient id="amountGradient" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor={chartTheme.colors[1]} stopOpacity={0.4} />
              <stop offset="50%" stopColor={chartTheme.colors[1]} stopOpacity={0.1} />
              <stop offset="100%" stopColor={chartTheme.colors[1]} stopOpacity={0} />
            </linearGradient>
          </defs>
