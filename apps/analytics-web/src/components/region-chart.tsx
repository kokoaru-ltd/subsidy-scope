...
export function RegionChart({ data, height = 400 }: RegionChartProps) {
  const chartData = (data ?? regionData.slice(0, 10)).slice().reverse();
        ...
        <BarChart data={chartData} layout="vertical" margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
          <defs>
            <linearGradient id="barGradient" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0%" stopColor={chartTheme.accent} stopOpacity={0.6} />
